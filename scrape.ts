...
const DIRECTUS_API_ENDPOINT = 'https://cms.softagon.app/items/transferencias_constitucionais';
...
var q = async.queue(function(task: { data: any }, callback: (err?: Error) => void) {
